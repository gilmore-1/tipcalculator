...
import { Bill, BillInput, BillInputDiv, CountedAmount, Left, NumberPeople, ResetBtn, Right, SelectText, TipAmountTitle, TipAndTotal, TipButton, TipButtonContainer, TipWrapper } from "./TipCardStyle";
import { Helmet } from "react-helmet";
import { ThemeProvider } from "styled-components";
import { myTheme } from "../../theme/defaultTheme";
        ...
        <TipWrapper>
            ...
            <TipButtonContainer>
              {[5, 10, 15].map((value, index) => (
                <TipButton
                  ...
                  style={
                    tip === value
                      ? { backgroundColor: "#26C2AE", color: "#fff" }
                      : {}
                  }
          ...
          <Right>
            <TipAndTotal>
              ...
              <CountedAmount>
                {isNaN(tipAmountPerPerson) && isNaN(totalPerPerson)
                  ? "$0"
